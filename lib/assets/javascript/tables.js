...
$(document).ready(function() {
  ...
  $('#tabelaProduto_filter input[type=search]').keyup(function () {
    var table = $('#table_Produto').DataTable();
    table.search(
  ...
  $('#tabelaEstoque_filter input[type=search]').keyup(function () {
    var table = $('#table_Estoque').DataTable();
    table.search(
        jQuery.fn.DataTable.ext.type.search.string(this.value)
    ).draw();
  });
  ...
  $('#tabelaFornecedor_filter input[type=search]').keyup(function () {
    var table = $('#table_Fornecedor').DataTable();
    table.search(
        jQuery.fn.DataTable.ext.type.search.string(this.value)
    ).draw();
  });
  ...
  $('#tabelaProdutoindex_filter input[type=search]').keyup(function () {
    var table = $('#table_Produtoindex').DataTable();
    table.search(
        jQuery.fn.DataTable.ext.type.search.string(this.value)
    ).draw();
  });
